...
# status / title-bar identity (override via env)
HOST = os.environ.get("ASCII_HOST", "chandan@github")
DISPLAY_NAME = os.environ.get("ASCII_NAME", "Chandan Kumar")
...
status_prompt = f"{HOST}:~$ whoami "
# monospace approx: 7.8px per char at font-size 13
cursor_x = PAD + int(len(status_prompt + DISPLAY_NAME) * 7.8) + 4
